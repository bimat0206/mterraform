...
output "connection_string" {
  ...
  value       = "Server=${aws_db_instance.this.address},${aws_db_instance.this.port};Database=${aws_db_instance.this.db_name != null ? aws_db_instance.this.db_name : "master"};User Id=${aws_db_instance.this.username};"
}

output "sqlcmd_command" {
  description = "sqlcmd command to connect to the database"
  value       = "sqlcmd -S ${aws_db_instance.this.address},${aws_db_instance.this.port} -U ${aws_db_instance.this.username} -d ${aws_db_instance.this.db_name != null ? aws_db_instance.this.db_name : "master"}"
}
