...
output "instance_arn" {
  description = "The ARN of the Linux EC2 instance"
  value       = aws_instance.this.arn
}

output "instance_name" {
  description = "The name of the Linux EC2 instance"
  value       = local.name
}
...
output "ipv6_addresses" {
  description = "List of IPv6 addresses assigned to the instance"
...
output "ami_name" {
  ...
  value       = var.ami_id == "" ? data.aws_ami.linux[0].name : null
}
...
output "ssh_connection_command" {
  ...
  value       = var.key_name != "" ? "ssh -i /path/to/${var.key_name}.pem ec2-user@${var.associate_public_ip_address ? aws_instance.this.public_ip : aws_instance.this.private_ip}" : "N/A - key_name not specified"
}
