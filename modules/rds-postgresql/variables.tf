...
variable "service" {
  type        = string
  default     = ""
  description = "Service name (e.g., api, web). If empty, will use 'postgresql'"
}
...
variable "engine_version" {
  type        = string
  default     = "16.1"
  description = "PostgreSQL engine version (15.x, 16.x, etc.)"
}
...
variable "enabled_cloudwatch_logs_exports" {
  ...
  description = "CloudWatch Logs exports (postgresql, upgrade)"
}
...
variable "parameter_group_family" {
  type        = string
  default     = "postgres16"
  description = "Parameter group family (postgres15, postgres16, etc.)"
}
...
# -----------------------------------------------------------------------------
# Option Group Configuration (PostgreSQL doesn't use this much)
# -----------------------------------------------------------------------------
